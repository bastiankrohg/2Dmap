# v7 - Field of View for mast

import pygame 
import sys
from components.map_management import save_map, load_map, get_last_used_map, list_maps
from components.drawing import draw_grid, draw_rover, draw_path, draw_obstacles, draw_resources, draw_arrows, draw_fov
...
def game_loop(map_name=None):
    ...
    global resources, obstacles, show_resource_list, show_obstacle_list, view_offset
